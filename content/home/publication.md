...
+++
 ...
 <div align="justify"> 
	<h3>Journals:</h3>
   <ol start="1">
     <li>Kumar, V., Halder, J., Mitra, A., Oki, E., and <u>Chatterjee, B.C.</u>, “VNEavXT: Offline Virtual Network Embedding Model Considering Crosstalk-Avoided Approach in Spectrally-Spatially Elastic Optical Networkss,” <em>IEEE Transactions on Network Science and Engineering</em>, 2024, IF: 6.7 [to appear].</li>
